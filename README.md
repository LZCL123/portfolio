...
我的求职作品集网站,汇总大学期间的主要项目、实习经历与技能,求职方向为 Java 开发 / Agent 开发。
...
- [NEON FLUX](https://github.com/LZCL123/neon-flux) — Three.js + MediaPipe 手势识别的 3D 粒子交互页
...
`resume.pdf` 为最新简历,网页右上角「下载简历」按钮也可直接下载。
